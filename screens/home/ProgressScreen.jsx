...
export default function ProgressScreen({ navigation }) {
  ...
  useEffect(() => {
    const weeklyData = [];
    const firstSessionDate = Object.keys(completedWorkoutDates).length > 0 ? new Date(Object.keys(completedWorkoutDates)[0]) : new Date();
    ...
    while (weekStart <= lastSessionDate) {
      ...
      const weekLabel = `${moment(weekStart).format('M/D')} - ${moment(weekEnd).format('M/D')}`;
            ...
            <View>
              ...
              <ScrollView horizontal>
                <View style={styles.chartContainer}>
                  <Text style={styles.chartTitle}>Total Workout Duration Per Day</Text>
                  <BarChart
                    data={{
              ...
              <View style={{ alignItems: 'center' }}>
                <Text style={[styles.chartTitle, { marginBottom: 10, marginTop: 10 }]}>Progress Statistics </Text>
              </View>
              ...
              <View style={{ alignItems: 'center', marginTop: 30 }}>
                ...
                >
                  ...
                  <FontAwesome name="arrow-right" size={20} color="#0044AA" />
                </Pressable>
              </View>
